...
stations = stations['station_id'].to_list()
for station_id in stations:
    ...
    # Fit new segments for comparison
    print("\nFitting new segments for comparison...")

    result = fitter.fit_segments(n_segments=len(existing_segments))
